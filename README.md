...
The latest binary build for [Windows is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-03-29_20-11-54-Windows-Win32-4.0-Current-b6f02f3e.zip?raw=true), [Linux is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-03-29_15-51-16-Linux-x86_64-4.0-Current-b6f02f3e.tgz?raw=true), and for [macOS is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-06-03_14-59-01-macOS-i386-4.0-Current-e57fdb87.tgz?raw=true).
