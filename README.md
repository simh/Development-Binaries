...
The latest binary build for [Windows is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-12-04_22-56-31-Windows-Win32-4.0-Current-f4f30298.zip?raw=true), [Linux is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-12-17_16-51-58-Linux-x86_64-4.0-Current-a8ff8110.tgz?raw=true), and for [macOS is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-12-17_15-09-28-macOS-i386-4.0-Current-a8ff8110.tgz?raw=true).
