...
The latest binary build for [Windows is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-03-22_02-41-49-Windows-Win32-4.0-Current-f7dfefee.zip?raw=true), [Linux is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-03-29_00-40-28-Linux-x86_64-4.0-Current-0ca076bb.tgz?raw=true), and for [macOS is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-03-28_22-44-05-macOS-i386-4.0-Current-0ca076bb.tgz?raw=true).
