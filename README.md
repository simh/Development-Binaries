...
The latest binary build for [Windows is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-10-07_01-32-10-Windows-Win32-4.0-Current-985137cb.zip?raw=true), [Linux is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-08-26_21-27-39-Linux-x86_64-4.0-Current-6d5661c8.tgz?raw=true), and for [macOS is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-10-14_03-32-01-macOS-i386-4.0-Current-6433542c.tgz?raw=true).
