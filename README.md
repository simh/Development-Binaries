...
The latest binary build for [Windows is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-06-06_03-47-14-Windows-Win32-4.0-Current-ca848d92.zip?raw=true), [Linux is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-06-21_23-23-30-Linux-x86_64-4.0-Current-524a98b2.tgz?raw=true), and for [macOS is here](https://github.com/simh/Development-Binaries/blob/master/simh-2024-06-21_17-23-51-macOS-i386-4.0-Current-524a98b2.tgz?raw=true).
