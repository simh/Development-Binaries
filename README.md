...
The latest binary build for [Windows is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-10-14_09-30-26-Windows-Win32-4.0-Current-6433542c.zip?raw=true), [Linux is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-10-14_05-16-45-Linux-x86_64-4.0-Current-6433542c.tgz?raw=true), and for [macOS is here](https://github.com/simh/Development-Binaries/blob/master/simh-2023-10-14_03-32-01-macOS-i386-4.0-Current-6433542c.tgz?raw=true).
